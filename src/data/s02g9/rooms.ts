...
export const rooms: RoomConfig[] = [
  {
    id: 'lobby',
    name: 'Entrance Lobby',
    panorama: assetPath('/csarch2-virtual-exhibits/s02g9/rooms/new_panorama.webp'),
    hotspots: [
      {
        id: 'to-classical',
        type: 'navigation',
      ...
      },
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/caesar-cipher.webp'),
  ...
  },
  {
    ...
    hotspots: [
      ...
      },
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/vigenere-table.webp'),
        buttonLabel: 'Open Simulator',
        exhibitKey: 'vigenere'
      },
      {
  ...
  },
  {
    ...
    hotspots: [
      ...
      },
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/bletchley-colossus.jpg'),
    ...
    hotspots: [
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/rotor-machine.webp'),
        buttonLabel: 'Open Simulator',
        exhibitKey: 'enigma'
      },
      {
    ...
    hotspots: [
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/Bombe.webp'),
        buttonLabel: 'Open Exhibit',
        exhibitKey: 'bombe'
      },
      {
    ...
    hotspots: [
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/Harvard.webp'),
        buttonLabel: 'Open Exhibit',
        exhibitKey: 'mark1'
      },
      {
    ...
    hotspots: [
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/ENIAC.webp'),
        buttonLabel: 'Open Exhibit',
        exhibitKey: 'eniac'
      },
      {
    ...
    hotspots: [
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/UNIVAC.webp'),
        buttonLabel: 'Open Exhibit',
        exhibitKey: 'univac'
      },
      {
    ...
    hotspots: [
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/concepts.webp'),
    ...
    hotspots: [
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/comparison.webp'),
    ...
    hotspots: [
      {
        ...
        image: assetPath('/csarch2-virtual-exhibits/s02g9/Finale.jpg'),
